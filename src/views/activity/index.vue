  ...
  <div class="app-container">
    <el-card class="box-card" shadow="never">
      ...
      <el-form :inline="true" class="demo-form-inline" :size="'small'">
        <el-form-item label="场馆名称">
          <el-input v-model="page.vaName" placeholder="场馆名称"></el-input>
        </el-form-item>
    ...
    <div class="mt-3">
      ...
      >
        ...
        <el-table-column prop="aName" label="活动名称" width="200"></el-table-column>
        <el-table-column prop="aEnable" label="状态" width="180"></el-table-column>
        <el-table-column prop="aCreationtime" label="创建时间" width="180"></el-table-column>
        <el-table-column prop="aTicketnumber" label="票务数量" width="180"></el-table-column>
        <el-table-column prop="aEmployeenumber" label="工作证总数" width="180"></el-table-column>
        <el-table-column prop="aNote" label="备注"></el-table-column>
    ...
    <el-dialog title="创建活动" :visible.sync="dialogAddVisible">
      <el-form ref="addForm" :rules="addFormrules" :model="addForm" label-width="80px">
        <el-form-item label="活动名称" prop="vaName">
          <el-input v-model="addForm.vaName"></el-input>
        </el-form-item>
        <el-form-item label="备注" prop="vaNote">
          <el-input v-model="addForm.vaNote"></el-input>
        </el-form-item>
        ...
        <el-form-item label="票务总数" prop="vaTicketnumber">
          <el-input v-model.number="addForm.vaTicketnumber"></el-input>
        </el-form-item>
        <el-form-item label="工证总数" prop="vaEmployeenumber">
          <el-input v-model.number="addForm.vaEmployeenumber"></el-input>
        </el-form-item>
...
export default {
  ...
  methods: {
    init() {
      ...
      let { current, size, vaName, vaEnable } = this.page;
      let form = {
        current: current,
        size: size,
        vaName: vaName,
